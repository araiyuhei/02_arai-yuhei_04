...
--
-- Host: 127.0.0.1
-- Generation Time: 2019 年 3 朁E05 日 09:04
...
INSERT INTO `aa` (`id`, `name`, `naiyou`, `indate`) VALUES
(11, 'おつかい', 'バニラアイス', '2019-02-08 22:12:14'),
(12, '修ちゃんと飲み会', '立川', '2019-02-08 22:12:40');
...
INSERT INTO `a_table` (`id`, `name`, `naiyou`) VALUES
(1, '就職キャンプ1', 'テスト1'),
(2, 'shimada', 'ハーデス最高'),
(3, '第', 'aaaaaaaaaaaaaaaa'),
(4, '', ''),
(12, 'asdas', '今日は補講');
...
--
-- Indexes for table `aa_table`
--
ALTER TABLE `aa_table`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `aa_table`
--
ALTER TABLE `aa_table`
...
-- Database: `b_db`
--
CREATE DATABASE IF NOT EXISTS `b_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `b_db`;
...
(1, '就職キャンプ1', 60, 'テキスト1', '2018-06-06 00:00:00'),
(2, '就職キャンプ2', 90, 'テキスト1', '2018-06-06 00:00:00'),
(3, '就職キャンプ3', 30, 'テキスト1', '2018-06-06 00:00:00'),
(4, '就職キャンプ4', 55, 'テキスト1', '2018-06-06 00:00:00'),
(5, '就職キャンプ5', 55, 'テキスト1', '2018-06-06 00:00:00');
...
--
-- テーブルのデータのダンプ `pma__navigationhiding`
--

INSERT INTO `pma__navigationhiding` (`username`, `item_name`, `item_type`, `db_name`, `table_name`) VALUES
('root', 'a_table', 'table', 'a_db', '');
...
('root', '[{\"db\":\"a_db\",\"table\":\"aa\"},{\"db\":\"a_db\",\"table\":\"aa_table\"},{\"db\":\"test_table\",\"table\":\"test_table\"},{\"db\":\"a_db\",\"table\":\"a_table\"},{\"db\":\"todo\",\"table\":\"todo_table\"},{\"db\":\"b_db\",\"table\":\"b_table\"}]');
...
('root', '2019-03-05 07:59:17', '{\"lang\":\"ja\",\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `test_table`
--
CREATE DATABASE IF NOT EXISTS `test_table` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `test_table`;
